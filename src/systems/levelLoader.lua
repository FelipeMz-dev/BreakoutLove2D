local Json = require("src.systems.simpleJson")
local Brick = require("src.entities.brick")
...
function LevelLoader:createBricks(levelConfig)
    ...
    for row = 1, rows do
        ...
        for col = 1, columns do
            ...
            local brick = Brick:new(x, y, brickWidth, brickHeight, resistance, rowColors)
            brick.color = rowColors[1]
